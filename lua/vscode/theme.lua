...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Comment', { fg = c.vscDarkGreen, bg = 'NONE', italic = opts.italic_comments })
    ...
    hl(0, '@attribute', { fg = c.vscLightRed, bg = 'NONE' })
    ...
    hl(0, '@method', { fg = c.vscYellowOrange, bg = 'NONE' })
    ...
    hl(0, '@include', { fg = c.vscPurple, bg = 'NONE' })
    hl(0, '@preprocessor', { fg = c.vscPurple, bg = 'NONE' })
    ...
    hl(0, '@text.strike', { fg = c.vscFront, bg = 'NONE', strikethrough = true })
